    ...
    () => [
      {
        ...
        classes: [
          { label: 'TK A Patimura', levelId: 'tk-a', groupName: 'Jenjang TK' },
          { label: 'TK B Diponegoro', levelId: 'tk-b', groupName: 'Jenjang TK' },
          { label: 'TK B Jendral Sudirman', levelId: 'tk-b', groupName: 'Jenjang TK' },
          { label: 'TK B Pangeran Antasari', levelId: 'tk-b', groupName: 'Jenjang TK' },
        ],
      },
      {
        group: 'Jenjang SD (Sekolah Dasar)',
        classes: [
          { label: 'Kelas 1 Abu Bakar', levelId: 'sd-1', groupName: 'Jenjang SD' },
          { label: 'Kelas 1 Umar Bin Khattab', levelId: 'sd-1', groupName: 'Jenjang SD' },
          { label: 'Kelas 2 Ali Bin Abi Thalib', levelId: 'sd-2', groupName: 'Jenjang SD' },
          { label: 'Kelas 2 Thalhah bin Ubaidillah', levelId: 'sd-2', groupName: 'Jenjang SD' },
          { label: 'Kelas 2 Utsman bin Affan', levelId: 'sd-2', groupName: 'Jenjang SD' },
          { label: 'Kelas 3 Abdurrahman Bin Auf', levelId: 'sd-3', groupName: 'Jenjang SD' },
          { label: 'Kelas 3 Bilal Bin Rabah', levelId: 'sd-3', groupName: 'Jenjang SD' },
          { label: 'Kelas 3 Khalid Bin Walid', levelId: 'sd-3', groupName: 'Jenjang SD' },
          { label: 'Kelas 4 Muadz Bin Jabbal', levelId: 'sd-4', groupName: 'Jenjang SD' },
          { label: 'Kelas 4 Said Bin Zaid', levelId: 'sd-4', groupName: 'Jenjang SD' },
          { label: 'Kelas 4 Zubair Bin Awwam', levelId: 'sd-4', groupName: 'Jenjang SD' },
          { label: 'Kelas 5 Hamzah bin Abdul Muthalib', levelId: 'sd-5', groupName: 'Jenjang SD' },
          { label: 'Kelas 5 Hudzaifah Bin Al Yaman', levelId: 'sd-5', groupName: 'Jenjang SD' },
          { label: 'Kelas 5 Saad Bin Abi Waqqash', levelId: 'sd-5', groupName: 'Jenjang SD' },
          { label: 'Kelas 6 Abu Ubaidah Bin Al-Jarrah', levelId: 'sd-6', groupName: 'Jenjang SD' },
          { label: 'Kelas 6 Amr Bin Ash', levelId: 'sd-6', groupName: 'Jenjang SD' },
          { label: 'Kelas 6 Anas Bin Malik', levelId: 'sd-6', groupName: 'Jenjang SD' },
        ],
      },
      {
        group: 'Jenjang SMP (Sekolah Menengah Pertama)',
        classes: [
          { label: 'Kelas 7 Salman Alfarisi', levelId: 'smp-7', groupName: 'Jenjang SMP' },
          { label: 'Kelas 8 Abu Hurairah', levelId: 'smp-8', groupName: 'Jenjang SMP' },
          { label: 'Kelas 8 Mushab Bin Umair', levelId: 'smp-8', groupName: 'Jenjang SMP' },
          { label: 'Kelas 9 Amr bin Yasir', levelId: 'smp-9', groupName: 'Jenjang SMP' },
        ],
      },
      {
        group: 'Jenjang SMA (Sekolah Menengah Atas)',
        classes: [
          { label: 'Kelas 10 Muhammad Al-Fatih', levelId: 'sma-10', groupName: 'Jenjang SMA' },
          { label: 'Kelas 11 Thariq bin Ziyad', levelId: 'sma-11', groupName: 'Jenjang SMA' },
          { label: 'Kelas 12 Salahudin Al-Ayyubi', levelId: 'sma-12', groupName: 'Jenjang SMA' },
        ],
      },
    ],
    []
