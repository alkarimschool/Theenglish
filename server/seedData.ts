...
export const INITIAL_USERS: User[] = [
  {
    ...
    assignedClasses: [
      'TK A Patimura', 'TK B Diponegoro', 'TK B Jendral Sudirman', 'TK B Pangeran Antasari',
      'Kelas 1 Abu Bakar', 'Kelas 1 Umar Bin Khattab', 'Kelas 2 Ali Bin Abi Thalib', 'Kelas 2 Thalhah bin Ubaidillah', 'Kelas 2 Utsman bin Affan',
      'Kelas 3 Abdurrahman Bin Auf', 'Kelas 3 Bilal Bin Rabah', 'Kelas 3 Khalid Bin Walid', 'Kelas 4 Muadz Bin Jabbal', 'Kelas 4 Said Bin Zaid', 'Kelas 4 Zubair Bin Awwam',
      'Kelas 5 Hamzah bin Abdul Muthalib', 'Kelas 5 Hudzaifah Bin Al Yaman', 'Kelas 5 Saad Bin Abi Waqqash', 'Kelas 6 Abu Ubaidah Bin Al-Jarrah', 'Kelas 6 Amr Bin Ash', 'Kelas 6 Anas Bin Malik',
      'Kelas 7 Salman Alfarisi', 'Kelas 8 Abu Hurairah', 'Kelas 8 Mushab Bin Umair', 'Kelas 9 Amr bin Yasir',
      'Kelas 10 Muhammad Al-Fatih', 'Kelas 11 Thariq bin Ziyad', 'Kelas 12 Salahudin Al-Ayyubi'
    ],
    isActive: true,
  ...
  },
  {
    ...
    assignedLevelIds: ['tk'],
    assignedClasses: ['TK A Patimura', 'TK B Diponegoro'],
    isActive: true,
  ...
  },
  {
    ...
    assignedLevelIds: ['sd'],
    assignedClasses: ['Kelas 1 Abu Bakar', 'Kelas 1 Umar Bin Khattab'],
    isActive: true,
    createdAt: '2026-01-05T08:00:00Z',
  },
  {
    ...
    assignedLevelIds: ['sd'],
    assignedClasses: ['Kelas 3 Abdurrahman Bin Auf', 'Kelas 3 Bilal Bin Rabah'],
    isActive: true,
    createdAt: '2026-01-05T08:00:00Z',
  },
  {
    ...
    assignedLevelIds: ['sd'],
    assignedClasses: ['Kelas 5 Hamzah bin Abdul Muthalib', 'Kelas 5 Hudzaifah Bin Al Yaman'],
    isActive: true,
    createdAt: '2026-01-05T08:00:00Z',
  },
  {
    ...
    assignedLevelIds: ['sd'],
    assignedClasses: ['Kelas 4 Muadz Bin Jabbal', 'Kelas 5 Saad Bin Abi Waqqash', 'Kelas 6 Abu Ubaidah Bin Al-Jarrah'],
    isActive: true,
    createdAt: '2026-01-05T08:00:00Z',
  },
  {
    ...
    assignedClasses: ['Kelas 7 Salman Alfarisi', 'Kelas 8 Abu Hurairah'],
    isActive: true,
    createdAt: '2026-01-05T08:00:00Z',
  },
  {
    ...
    assignedLevelIds: ['smp'],
    assignedClasses: ['Kelas 9 Amr bin Yasir'],
    isActive: true,
    createdAt: '2026-01-05T08:00:00Z',
  },
  {
    ...
    assignedClasses: ['Kelas 10 Muhammad Al-Fatih', 'Kelas 11 Thariq bin Ziyad'],
    isActive: true,
    createdAt: '2026-01-05T08:00:00Z',
  },
  {
    ...
    assignedLevelIds: ['sma'],
    assignedClasses: ['Kelas 12 Salahudin Al-Ayyubi'],
    isActive: true,
    createdAt: '2026-01-05T08:00:00Z',
  },
];
