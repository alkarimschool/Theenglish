...
export const INITIAL_LEVELS: Level[] = [
  // TK Levels (Pink/Rose Theme)
  {
    ...
    educationLevel: 'TK',
    numericGrade: 0,
    description: 'Playful English & Phonics (Kelas: TK A Patimura)',
    iconName: 'Smile',
    color: '#EC4899', // Pink
    order: 1,
  },
  {
    id: 'tk-b',
    name: 'TK B (Diponegoro, Sudirman, Antasari)',
    grade: 'TK B',
    schoolType: 'TK',
    educationLevel: 'TK',
    numericGrade: 0,
    description: 'Foundations & Words (Kelas: TK B Diponegoro, TK B Jendral Sudirman, TK B Pangeran Antasari)',
    iconName: 'Heart',
    color: '#F43F5E', // Rose
    order: 2,
  },

  // SD Levels (Amber/Orange Theme)
  {
    id: 'sd-1',
    name: 'Kelas 1 (Abu Bakar, Umar)',
    grade: 'SD Kelas 1',
    schoolType: 'SD',
    educationLevel: 'SD',
    numericGrade: 1,
    description: 'Primary Starter (Kelas: Kelas 1 Abu Bakar, Kelas 1 Umar Bin Khattab)',
    iconName: 'Sun',
    color: '#F59E0B', // Amber
    order: 3,
  },
  {
    id: 'sd-2',
    name: 'Kelas 2 (Ali, Thalhah, Utsman)',
    grade: 'SD Kelas 2',
    schoolType: 'SD',
    educationLevel: 'SD',
    numericGrade: 2,
    description: 'Primary Explorer (Kelas: Kelas 2 Ali Bin Abi Thalib, Kelas 2 Thalhah bin Ubaidillah, Kelas 2 Utsman bin Affan)',
    iconName: 'Star',
    color: '#EAB308', // Yellow
    order: 4,
  },
  {
    id: 'sd-3',
    name: 'Kelas 3 (Abdurrahman, Bilal, Khalid)',
    grade: 'SD Kelas 3',
    schoolType: 'SD',
    educationLevel: 'SD',
    numericGrade: 3,
    description: 'Primary Builder (Kelas: Kelas 3 Abdurrahman Bin Auf, Kelas 3 Bilal Bin Rabah, Kelas 3 Khalid Bin Walid)',
    iconName: 'Compass',
    color: '#84CC16', // Lime
    order: 5,
  },
  {
    id: 'sd-4',
    name: 'Kelas 4 (Muadz, Said, Zubair)',
    grade: 'SD Kelas 4',
    schoolType: 'SD',
    educationLevel: 'SD',
    numericGrade: 4,
    description: 'Primary Intermediate (Kelas: Kelas 4 Muadz Bin Jabbal, Kelas 4 Said Bin Zaid, Kelas 4 Zubair Bin Awwam)',
    iconName: 'TreePine',
  ...
  {
    id: 'sd-5',
    name: 'Kelas 5 (Hamzah, Hudzaifah, Saad)',
    grade: 'SD Kelas 5',
    schoolType: 'SD',
    educationLevel: 'SD',
    numericGrade: 5,
    description: 'Primary Advanced (Kelas: Kelas 5 Hamzah bin Abdul Muthalib, Kelas 5 Hudzaifah Bin Al Yaman, Kelas 5 Saad Bin Abi Waqqash)',
    iconName: 'BookOpen',
    color: '#06B6D4', // Cyan
    order: 7,
  },
  {
    id: 'sd-6',
    name: 'Kelas 6 (Abu Ubaidah, Amr, Anas)',
    grade: 'SD Kelas 6',
    schoolType: 'SD',
    educationLevel: 'SD',
    numericGrade: 6,
    description: 'Primary Graduate (Kelas: Kelas 6 Abu Ubaidah Bin Al-Jarrah, Kelas 6 Amr Bin Ash, Kelas 6 Anas Bin Malik)',
    iconName: 'Sparkles',
    color: '#0284C7', // Sky
    order: 8,
  },

  // SMP Levels (Emerald/Teal Theme)
  {
    id: 'smp-7',
    name: 'Kelas 7 Salman Alfarisi',
    grade: 'SMP Kelas 7',
    schoolType: 'SMP',
    educationLevel: 'SMP',
    numericGrade: 7,
    description: 'Junior High Foundations (Kelas: Kelas 7 Salman Alfarisi)',
    iconName: 'BookOpen',
  ...
  {
    id: 'smp-8',
    name: 'Kelas 8 (Abu Hurairah, Mushab)',
    grade: 'SMP Kelas 8',
    schoolType: 'SMP',
    educationLevel: 'SMP',
    numericGrade: 8,
    description: 'Junior High Intermediate (Kelas: Kelas 8 Abu Hurairah, Kelas 8 Mushab Bin Umair)',
    iconName: 'Sparkles',
    color: '#10B981', // Teal
    order: 10,
  },
  {
    id: 'smp-9',
    name: 'Kelas 9 Amr bin Yasir',
    grade: 'SMP Kelas 9',
    schoolType: 'SMP',
    educationLevel: 'SMP',
    numericGrade: 9,
    description: 'Junior High Advanced (Kelas: Kelas 9 Amr bin Yasir)',
    iconName: 'Award',
    color: '#0D9488', // Teal Dark
    order: 11,
  },

  // SMA Levels (Blue/Indigo Theme)
  {
    id: 'sma-10',
    name: 'Kelas 10 Muhammad Al-Fatih',
    grade: 'SMA Kelas 10',
    schoolType: 'SMA',
    educationLevel: 'SMA',
    numericGrade: 10,
    description: 'Senior High Foundations (Kelas: Kelas 10 Muhammad Al-Fatih)',
  ...
  {
    id: 'sma-11',
    name: 'Kelas 11 Thariq bin Ziyad',
    grade: 'SMA Kelas 11',
    schoolType: 'SMA',
    educationLevel: 'SMA',
    numericGrade: 11,
    description: 'Analytical & Critical (Kelas: Kelas 11 Thariq bin Ziyad)',
    iconName: 'Compass',
  ...
  {
    id: 'sma-12',
    name: 'Kelas 12 Salahudin Al-Ayyubi',
    grade: 'SMA Kelas 12',
    schoolType: 'SMA',
    educationLevel: 'SMA',
    numericGrade: 12,
    description: 'College & Global Readiness (Kelas: Kelas 12 Salahudin Al-Ayyubi)',
    iconName: 'Globe',
    color: '#1D4ED8', // Indigo
    order: 14,
  },
...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    assignedLevelIds: ['sma-10', 'sma-11'],
    isActive: true,
    createdAt: '2026-01-05T08:00:00Z',
  },
  {
