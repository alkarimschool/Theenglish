...
export const INITIAL_LEVELS: Level[] = [
  // TK Levels (Pink/Rose Theme)
  {
    ...
    educationLevel: 'TK',
    numericGrade: 0,
    description: 'Playful English: Colors, basic greetings, animals, singing, and joyful phonics for early childhood.',
    iconName: 'Smile',
    color: '#EC4899', // Pink
    order: 1,
  },
  {
    ...
    educationLevel: 'TK',
    numericGrade: 0,
    description: 'Foundations & Words: Numbers, fruits, family members, polite magic words, and joyful speech.',
    iconName: 'Heart',
    color: '#F43F5E', // Rose
    order: 2,
  },
  ...
  // SD Levels (Amber/Orange Theme)
  {
    ...
    educationLevel: 'SD',
    numericGrade: 1,
    description: 'Primary Starter: Classroom objects, self-introduction, colors, simple actions, and polite greetings.',
    iconName: 'Sun',
    color: '#F59E0B', // Amber
    order: 3,
  },
  {
    ...
    educationLevel: 'SD',
    numericGrade: 2,
    description: 'Primary Explorer: Family, parts of the body, pets, asking permission, and daily routines.',
    iconName: 'Star',
    color: '#EAB308', // Yellow
    order: 4,
  },
  {
    ...
    educationLevel: 'SD',
    numericGrade: 3,
    description: 'Primary Builder: Food & drinks, weather, telling time, simple dialogues, and short speech.',
    iconName: 'Compass',
    color: '#84CC16', // Lime
    order: 5,
  },
  {
    ...
    educationLevel: 'SD',
    numericGrade: 4,
    description: 'Primary Intermediate: Wild & farm animals, school subjects, asking directions, and nature conservation.',
    iconName: 'TreePine',
  ...
  },
  {
    ...
    educationLevel: 'SD',
    numericGrade: 5,
    description: 'Primary Advanced: Hobbies, occupations, public places, expressing feelings, and presentation speech.',
    iconName: 'BookOpen',
    color: '#06B6D4', // Cyan
    order: 7,
  },
  {
    ...
    educationLevel: 'SD',
    numericGrade: 6,
    description: 'Primary Graduate: Holiday experiences, invitations, environmental awareness, and graduation speech.',
    iconName: 'Sparkles',
    color: '#0284C7', // Sky
    order: 8,
  },
  ...
  // SMP Levels (Emerald/Teal Theme)
  {
    ...
    educationLevel: 'SMP',
    numericGrade: 7,
    description: 'Junior High Foundations: Basic communication, greetings, simple present tense, daily habits, and nature exploration.',
    iconName: 'BookOpen',
  ...
  },
  {
    ...
    educationLevel: 'SMP',
    numericGrade: 8,
    description: 'Junior High Intermediate: Past experiences, comparative adjectives, recount texts, and transactional dialogue.',
    iconName: 'Sparkles',
    color: '#10B981', // Teal
    order: 10,
  },
  {
    ...
    educationLevel: 'SMP',
    numericGrade: 9,
    description: 'Junior High Advanced: Narrative texts, report writing, passive voice, and expressing hopes, wishes, and congratulations.',
    iconName: 'Award',
  ...
  // SMA Levels (Blue/Indigo Theme)
  {
    ...
    educationLevel: 'SMA',
    numericGrade: 10,
    description: 'Senior High Foundations: Descriptive texts, congratulating others, expressing intention, and complex tenses.',
  ...
  },
  {
    ...
    educationLevel: 'SMA',
    numericGrade: 11,
    description: 'Analytical & Critical: Analytical expositions, cause and effect, passive voice, and formal presentation debates.',
    iconName: 'Compass',
  ...
  },
  {
    ...
    educationLevel: 'SMA',
    numericGrade: 12,
    description: 'College & Global Readiness: Application letters, news items, conditional sentences, captions, and leadership speech.',
    iconName: 'Globe',
